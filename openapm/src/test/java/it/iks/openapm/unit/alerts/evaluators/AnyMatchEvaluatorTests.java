...
@SpringBootTest()
public class AnyMatchEvaluatorTests extends EvaluatorTestCase {
    @Test
    public void it_matches_on_one_element_list() {
        Evaluator evaluator = new AnyMatchEvaluator();
    ...
    @Test
    public void it_matches_on_discordant_multiple_elements_list() {
        Evaluator evaluator = new AnyMatchEvaluator();
        assertThat(evaluator.evaluate(Arrays.asList(
                condition(true),
                condition(false)
